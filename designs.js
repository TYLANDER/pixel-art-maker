...
//use an event listener to submit. This is the makeGrid function that does all the heavy lifting.
document.getElementById("sizePicker").onsubmit = function makeGrid() {
